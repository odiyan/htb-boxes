...
* obtain an email by creating an issue on osticket
  as mention one the [[file:d:/code/htb/academy/modules/attacking-common-applications/osticket.org::*Attacking osTicket][osticket module]], let's create a ticket and ge a temporary email id
