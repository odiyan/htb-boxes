...
* interact with the application
  ...
  +looks liks thie might be vulnerable to sql injection?+; ok probably not, this is just a
  static error page that's returned when you click the =Search= button. the content of the error
  page is just the above image
