...
** streamio.htb
   NOTE: don't use =-s=
  #+begin_src 
  ffuf -w /usr/share/seclists/Discovery/Web-Content/directory-list-2.3-small.txt:FUZZ -u https://streamio.htb/FUZZ.php
...
** watch.streamio.htb 
   NOTE: don't use =-s=
   #+begin_src 
   $ ffuf -w /usr/share/seclists/Discovery/Web-Content/directory-list-2.3-small.txt:FUZZ -u https://watch.streamio.htb/FUZZ.php
